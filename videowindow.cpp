...
{
    DEBUG() << "cut play!";
    mCornerHint->setText( QString("切歌") );
    mMediaObject->stop();
    sgnlSongEnded();
}
...
{
    QString str = QString("加入：") + aSong.getSinger() + QString("　") + aSong.getSongName();
